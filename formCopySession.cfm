...
<cfelse>
	...
	<cfif not up2snuff>
		...
		<cfinclude template="incError.cfm">
	<cfelse>
		<cfset pageTitle = "Copy Instructional Session">
		<cfinclude template="incBegin.cfm">
		...
		<cfinclude template="incJSShowDepartments.cfm">
			<script language="JavaScript" type="text/javascript">
				<!--
					...
					var elts = new Array( ActivityTypeID, DeliveryModeID, QuarterID, SessionDate, Hour, Marker  );
				...
				<form action="copySession.cfm"
					...
					<div class="form">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr valign="top">
								<td>
									Modify values (e.g., session date, duration, number of students) as needed.  Then click &quot;OK&quot; to create a new session.
								</td>
							</tr>
							<tr valign="top">
								<td>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<tr valign="top">
								<td colspan="2">
									...
									<textarea name="other_multi_dept" cols="50" rows="5"><cfif isDefined("FORM.other_multi_dept")>#FORM.other_multi_dept#<cfelseif isDefined("Sess.other_multi_dept")>#Sess.other_multi_dept#<cfelse></cfif></textarea>
								</td>
							</tr>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<input name="OldActID" type="hidden" value="#ActID#">
									<input name="OldSessID" type="hidden" value="#SessID#">
