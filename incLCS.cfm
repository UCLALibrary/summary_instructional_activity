...
<table width="98%" border="1" cellspacing="1" cellpadding="1" summary="Library Special Collections for Fiscal Year">
	<caption align="center" style="font-weight:bold">
		Library Special Collections Report
		<cfoutput>
...
<cfoutput query="Types">
	...
	<cfinclude template="incLCSUnits.cfm">
	<cfloop query="Units">
